...
const EngCard = ({
  ...
  return (
    <div
      className="relative justify-center w-full max-w-sm min-h-[14rem] bg-gradient-to-br from-blue-400 to-blue-600 text-white flex flex-col rounded-xl shadow-xl cursor-pointer group p-4 transition-transform transform hover:scale-105"
